...
The main dataset used in this project comes from the Satellite Catalog (SATCAT) provided by CelesTrak:
...
One example of related work:
https://nattybumppo.github.io/rocket-launch-history/
This project presents the history of rocket launches over time, allowing users to explore launch activity through an interactive int3erce.-
